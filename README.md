...
This repository contains the [Prometeo](https://github.com/Code-and-Response/Prometeo) solution that monitors the MQTT queue for new messages and in turn sends them to the [web application dashboard]().
